...
CREATE TABLE IF NOT EXISTS `admin_action_logs` (
  ...
  `action_type` enum('ROLE_ASSIGN','ROLE_REVOKE','POLICY_CREATE','POLICY_UPDATE','POLICY_EXPIRE','ORG_UPDATE','ORG_DEACTIVATE','PAYMENT_FORCE_CANCEL','REFUND_APPROVE','REFUND_REJECT','PRODUCT_APPROVE','PRODUCT_REJECT','USER_CREATE','USER_WITHDRAW','CATEGORY_CREATE','CATEGORY_UPDATE','CATEGORY_DEACTIVATE') NOT NULL,
...
INSERT INTO `products` (`product_id`, `seller_user_id`, `category_id`, `product_code`, `product_name`, `short_description`, `description`, `regular_price`, `sale_price`, `product_status`, `created_at`, `updated_at`) VALUES
	...
	(6, 2, 1, 'DELETE_TEST_ITEM', '삭제복원 기능 테스트상품', NULL, NULL, 111111.00, 111111.00, 'DELETED', '2026-09-22 21:28:00', '2026-09-22 21:29:00');
...
-- 테이블 데이터 shopdb2.refund_policies:~3 rows (대략적) 내보내기
...
-- 테이블 데이터 shopdb2.seller_profiles:~2 rows (대략적) 내보내기
